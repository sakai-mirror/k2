    ...
    DESCRIPTION
        .addSection(
            ...
            "The values are a , seperated list of key value pairs seperated by  "
                ...
                + "<li><em>GR The subject represents a group, the subject token and the permission "
                + "token will be consulted during resolution. eg s:GROUP:group22:maintain</li>"
                + "<li><em>AN Indicates the statement represents all users in all contexts. eg s:AN</li>"
                + "<li><em>AU Indicates the statement represents all authenticated users. eg s:AU</li>"
                + "<li><em>UN Indicates and undefined subject statement that should be ignored.</li>"
                + "<li><em>PR Provided come from external providers. s:PR:providerKey:additional_provider_data "
