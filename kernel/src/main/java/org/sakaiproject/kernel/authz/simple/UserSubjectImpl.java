 ...
 * 
 */
public class UserSubjectImpl implements UserSubjects {

  
  private Map<String, SubjectPermissions> subjectPermissionsMap = new ConcurrentHashMap<String, SubjectPermissions>();
  ...
  public void addSubjectPermissions(SubjectPermissions subjectPermissions) {
    subjectPermissionsMap.put(subjectPermissions.getSubjectToken(),subjectPermissions);
  }
  ...
  public SubjectPermissions getSubjectPermissions(String subjectToken) {
    return subjectPermissionsMap.get(subjectToken);
  }

  /**
   * {@inheritDoc}
   * @see org.sakaiproject.kernel.api.authz.UserSubjects#hasSubject(java.lang.String)
   */
  public boolean hasSubject(String subjectToken) {
    return subjectPermissionsMap.containsKey(subjectToken);
  }
