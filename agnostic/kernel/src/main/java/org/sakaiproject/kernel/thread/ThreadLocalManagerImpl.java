...
/**
 * <p>
 * ThreadLocalComponent provides the standard implementation of the Sakai
 * Framework ThreadLocalManager.
 * </p>
 */
public class ThreadLocalManagerImpl implements ThreadLocalManager {
  /** Our log (commons). */
  private static Log M_log = LogFactory.getLog(ThreadLocalManagerImpl.class);
